...
def fetch_side_hustle():
    try:
        ...
        response = requests.get('http://127.0.0.1:8000/side_hustles?apikey=72521')
...
def fetch_money_quote():
    try:
        ...
        response = requests.get("http://127.0.0.1:8000/money_quotes?apikey=72521")
        if response.status_code == 200:  # If request successful
...
if st.button("Get Inspired"):  # When user clicks button
    ...
    st.success(quote)  # Show the quote